...
svr = Server(name, run_save_path, num_workers=34, steps_to_ready=5,
...
#svr.add_hp('learning_rate_init', (0.00001, 0.005), init_sample_mode=[1000],
#           explore_method='perturb', explore_param=0.3, limit_explore=True, explorable=True)
...
svr.add_hp('l2_ic_enc_scale', (1e-5, 1e-3), init_sample_mode='logrand', explorable=True)

svr.add_hp('l2_con_scale', (1e-5, 1.0), init_sample_mode='logrand', explorable=True)
svr.add_hp('l2_ci_enc_scale', (1e-5, 1e-3), init_sample_mode='logrand', explorable=True)
...
svr.add_hp('valid_batch_size', [300])
...
svr.add_hp('kl_increase_epochs', [1])
svr.add_hp('l2_increase_epochs', [1])
